...
*  other files.  This is particularly important in no-std programming. For
*  example, the pow() operation is implemented inline with standard-lib integer
...
pub fn round_to_decimal(humidity: f32, rounding: u32) -> f32 {
  // no-std approach to rounding; push digits past the decimal, subtract 
...
//    - error handling, such as testing to ensure there is no overflow with
//      too high an exponent
